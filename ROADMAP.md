...
## 🚧 v0.1.0 — [code-complete; the pilot deploy remains](https://github.com/Directorium/Ordo/milestone/1)
**Standalone plugin — the 3mi.org pilot.** A self-contained MVP that bundles the Directorium Core engine and
...
& day view · #20 settings, i18n & assets. The one remaining item is **[#99](https://github.com/Directorium/Ordo/issues/99)
...
## 🗓️ Next — [v0.2.0](https://github.com/Directorium/Ordo/milestone/2)
**Thin client.** Replace the bundled engine with Directorium API calls, cache responses in WP transients
(transient cache), and degrade gracefully when the API is unreachable.

## 🔭 Future
- **[v0.3.0](https://github.com/Directorium/Ordo/milestone/3) — Configurable UI platform.** Reader
  switchers, tabbed settings (show/hide/lock), white-label palettes, accessibility, hour navigator +
  go-to-date, PWA/offline.
- **[v0.4.0](https://github.com/Directorium/Ordo/milestone/4) — Outputs & integrations.** Printable
  ordo + iCal + sacristy directive notes + necrology + print CSS.
- **[v1.0.0](https://github.com/Directorium/Ordo/milestone/5) — WordPress.org readiness.** Cut together
  with Core, Api, and Site.
- **[v1.1.0](https://github.com/Directorium/Ordo/milestone/6) — Mass & Office reader.** The reader
  surfaces inside the plugin + worship-aid output, plus an optional **"Why this day?" disclosure**
  (mockups-gated).
- **[v1.2.0](https://github.com/Directorium/Ordo/milestone/8) — Novus Ordo output.** The Novus Ordo
  surfaces inside the plugin.
- **[v2.0.0](https://github.com/Directorium/Ordo/milestone/7) — Comparison block.** An optional
